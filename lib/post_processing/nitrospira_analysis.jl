function nitrospira_analysis(sim_number)
    """This function does the analysis for the nitrospira validation cases."""
    ...
    # Dict used for the validation experiments in version 2.4.0
    ...
    # Calculate actives and moles per specie
